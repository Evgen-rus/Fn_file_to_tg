"""
Тестовая отправка письма с вложением через Yandex SMTP.
Работает только при EMAIL_PROVIDER=yandex в .env.
"""
import os
import sys
...
def send_test_email() -> None:
    ...
    if provider != "yandex":
        print("Для теста Yandex поменяйте EMAIL_PROVIDER в .env на yandex.")
        sys.exit(0)
    ...
    send_email_with_attachment(
        ...
        subject="Тестовая отправка файла (Yandex)",
